    ...
    <IonContent>
      <IonGrid className="table-grid">
        ...
        <IonRow className="table-header">
          <IonCol sizeMd="3" sizeXs="12" className="table-header-cell">Título</IonCol>
          <IonCol sizeMd="3" sizeXs="12" className="table-header-cell">Endereço</IonCol>
          <IonCol sizeMd="1" sizeXs="12" className="table-header-cell">Data</IonCol>
          <IonCol sizeMd="3" sizeXs="12" className="table-header-cell">Relatorio</IonCol>
          <IonCol sizeMd="2" sizeXs="12" className="table-header-cell"></IonCol>
        </IonRow>

        {projectList.map((project, idProject) => {
          if (project[0].introduction) {
            const { title, address, date, project_number } = project[0].introduction;

            return (
              <IonRow key={idProject} className="table-row">
                <IonCol sizeMd="3" sizeXs="12" className="table-cell">{title}</IonCol>
        ...
        <IonRow className="table-footer">
          <IonCol sizeMd="8" sizeXs="6" className="table-footer-cell">Total Project</IonCol>
          <IonCol sizeMd="4" sizeXs="6" className="table-footer-cell">{projectList.length}</IonCol>
        </IonRow>
      </IonGrid>
    </IonContent>
  );
